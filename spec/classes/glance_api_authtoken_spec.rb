  ...
  shared_examples 'glance_api authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_glance_api_config('keystone_authtoken/service_type').with_value('<SERVICE DEFAULT>')
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_glance_api_config('keystone_authtoken/service_type').with_value(params[:service_type])
    ...
    context 'when overriding parameters via params hash' do
      ...
      it 'configure keystone_authtoken' do
        is_expected.to contain_glance_api_config('keystone_authtoken/username').with_value(params[:params]['username'])
      end
    end
  end
